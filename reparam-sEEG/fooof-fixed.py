...
for file in spectra_files:
    ...
    fg_output = os.path.join('/Volumes/Nexus/Users/zouj/sEEG_data/fooof_outputs/fooof-fixed_1-200hz_pw25/fits',
    ...
    for ind in range(len(fg)):
        ...
        fooof_plot_path = os.path.join('/Volumes/Nexus/Users/zouj/sEEG_data/fooof_outputs/fooof-fixed_1-200hz_pw25',
                                                   'plots',
